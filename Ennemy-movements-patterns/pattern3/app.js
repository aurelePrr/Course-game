...
class Enemy {
    constructor() {
        ...
        this.angleSpeed = Math.random() * 0.5 + 0.5 // ADJUST SPEED ANIMATION
    ...
    update(){
       ...
       /*  SI THIS.X = THIS.Y ALORS TOURNE EN ROND 
        SI BAISSE VALEUR ( LA / DE MATH.PI) ALORS + VITE ET IVERSEMENT */
